...
import * as woldMap from '@highcharts/map-collection/custom/world.geo.json';
...
export class LivePageComponent implements OnInit{
  ...
  hightcharts: typeof Highcharts = Highcharts;
  ...
  ngOnInit(): void {
    this.dataService.getSummaryData().subscribe((data: any) => {
      ...
      this.hightcharts.mapChart('container', this.chartOptions);
    },
    (err) => {
      console.log(err);
    });
